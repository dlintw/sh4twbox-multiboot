...
setenv bootargs 'console=ttyAS0,115200 rootdelay=0 root=/dev/sda6 rootfstype=ext4 rw rootflags=data=journal nwhwconf=device:eth0,hwaddr:10:08:E2:12:06:BD phyaddr:0,watchdog:5000 mem=256M bigphysarea=2048'
